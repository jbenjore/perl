...
d_malloc_size='undef'
d_mblen='define'
d_mbr_gid_to_uuid='undef'
d_mbr_uid_to_uuid='undef'
d_mbr_check_membership='undef'
d_mbstowcs='define'
d_mbtowc='define'
d_memchr='define'
d_memcmp='define'
...
getgrgid_r_proto='0'
getgrnam_r_proto='0'
getgrouplist_basegid_type='gid_t'
getgrouplist_group_type='gid_t'
