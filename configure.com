...
$ i_utime = tmp
$!
$! Check to see if we've got uuid/uuid.h
$!
$ i_netdb = "undef"
$ tmp = "uuid/uuid.h"
$ GOSUB inhdr
...
$ WC "d_mblen='" + d_mblen + "'"
$ WC "d_mbr_gid_to_uuid='undef'"
$ WC "d_mbr_uid_to_uuid='undef'"
$ WC "d_mbr_check_membership='undef'"
...
$ WC "gidsize='4'"
$ WC "gidtype='" + gidtype + "'"
$ WC "getgrouplist_basegid_type='Gid_t'"
$ WC "getgrouplist_group_type='Gid_t'"
$ WC "groupstype='Gid_t'"
$ WC "hint='none'"
$ WC "hintfile='" + "'"
$ WC "i16size='" + i16size + "'"
